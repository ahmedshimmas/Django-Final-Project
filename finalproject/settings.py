...
SECRET_KEY = 'django-insecure-+#nfsf%0nd^bth!k75=#*qt=$!x8m2v3n9^32%do19$^+a4n)%'
...
AUTH_USER_MODEL = 'app.User' #to use the custom user model created in models file instead of the default user model for authentication.
...
EMAIL_HOST_PASSWORD = 'dwwugqsrnieyjtmd'
